...
*** Test Cases ***
S5.1: TC16 (Successful login), TC28 (Successful Deposit min), TC34 (Successful Withdraw min), TC41 (Transfer Account Number is not number)
...
S5.2: TC16 (Successful login), TC29 (Successful Deposit min+), TC35 (Successful Withdraw min+), TC42 (Transfer Account No. digit is not equal to 10 max-)
    Open browser cubank login page
    Wait cubank login page load complete
    Input and verify account no
    Input and verify account password
